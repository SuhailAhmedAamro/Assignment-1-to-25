...
// Guest List
let guests: string[] = ["Albert Einstein", "Isaac Newton", "Marie Curie"];
...
// Seeing the World
let placesToVisit: string[] = ["Paris", "Tokyo", "Rio de Janeiro", "Rome", "Sydney"];
...
let mountains: string[] = ["Everest", "K2", "Kangchenjunga", "Lhotse"];
console.log(mountains);

// TypeScript Objects
// Program to create objects containing information about different programming languages
let programmingLanguages: { name: string, paradigm: string }[] = [
